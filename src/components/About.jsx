        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
              We are a passionate team of designers, developers, and digital strategists dedicated to creating exceptional digital experiences. Our mission is to help businesses thrive in the digital landscape through innovative solutions and cutting-edge technology.
            </p>
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
              With years of experience and a portfolio of successful projects, we combine creativity with technical expertise to deliver results that exceed expectations. From concept to launch, we're your trusted partner in digital transformation.
            </p>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-center">
                ...
                <span className="text-gray-700 font-medium">Custom Web Development</span>
              </div>
              <div className="flex items-center">
                <div className="w-6 h-6 bg-blue-600 rounded-full flex items-center justify-center mr-4">
                  <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20">
                ...
                <span className="text-gray-700 font-medium">Responsive Design Excellence</span>
              </div>
              <div className="flex items-center">
                <div className="w-6 h-6 bg-blue-600 rounded-full flex items-center justify-center mr-4">
                  <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20">
                ...
                <span className="text-gray-700 font-medium">Digital Strategy & Consulting</span>
              </div>
              <div className="flex items-center">
                <div className="w-6 h-6 bg-blue-600 rounded-full flex items-center justify-center mr-4">
                  <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20">
                ...
                <span className="text-gray-700 font-medium">Ongoing Support & Maintenance</span>
              </div>
            </div>
