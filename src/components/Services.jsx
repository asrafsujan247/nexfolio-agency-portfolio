...
const Services = () => {
  const services = [
    ...
    },
    {
      ...
      description: 'Scalable cloud infrastructure and deployment solutions for modern web applications.',
      features: ['AWS/Azure Setup', 'DevOps', 'CI/CD Pipelines', 'Performance Monitoring']
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      features: ['Technology Audit', 'Strategic Planning', 'Architecture Design', 'Best Practices']
    }
  ]
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            We offer comprehensive digital solutions to help your business thrive in the modern digital landscape. From concept to deployment, we've got you covered.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            ...
            >
              ...
              {/* CTA Button */}
              <button className="w-full bg-gray-100 text-gray-700 py-3 rounded-xl hover:bg-blue-600 hover:text-white transition-all duration-300 font-medium">
                Learn More
              </button>
            </div>
          ))}
