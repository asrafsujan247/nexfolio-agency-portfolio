      ...
      <div className="container mx-auto px-6 py-16">
        ...
        <div className="grid lg:grid-cols-6 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            <div className="text-2xl font-bold mb-4">
              <span className="text-blue-400">Nex</span>Folio
            </div>
            <p className="text-gray-400 mb-6 leading-relaxed">
              We create digital excellence through innovative web solutions, stunning designs, and strategic digital marketing that drives real results for your business.
            </p>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            © {currentYear} NexFolio Agency. All rights reserved.
          </p>
